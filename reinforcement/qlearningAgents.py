...
class QLearningAgent(ReinforcementAgent):
    ...
    def computeValueFromQValues(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        QV = [self.getQValue(state, action) for action in self.getLegalActions(state)]
    ...
    def update(self, state, action, nextState, reward):
        ...
        self.QV[(state, action)] = new_value
        #util.raiseNotDefined()
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def getQValue(self, state, action):
        ...
        for f in feat:
            fvalue = feat[f]
            fweight = self.weights[f]
            totalvalue = totalvalue + (fvalue*fweight)
        return totalvalue     
        #util.raiseNotDefined()
    ...
    def final(self, state):
        ...
        if self.episodesSoFar == self.numTraining:
            ...
            "*** YOUR CODE HERE ***"
            print(self.weights, "are the weights")
            pass
